...
class MidoInterfaceDriverTestCase(testtools.TestCase):
    ...
    def setUp(self):
        ...
        self.api_p = mock.patch.object(sys.modules["midonetclient"].api, 'MidonetApi')
        self.api = self.api_p.start()
        self.addCleanup(self.api_p.stop)
        midonet_opts = [
    ...
    def test_plug(self):
        ...
        with mock.patch.object(utils, 'execute') as execute:
            self.driver.plug(self.network_id, self.port_id, 
                             self.device_name, self.mac_address,
                             self.bridge, self.namespace)
  
        expected = [mock.call(), mock.call('sudo'),
                    mock.call().add_veth(self.device_name, self.device_name,
    ...
    def test_unplug(self):
        ...
        self.ip_dev.assert_has_calls([mock.call(self.device_name, 
                                                self.driver.root_helper,
                                                self.namespace),
